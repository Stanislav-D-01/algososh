  ...
  return (
    <main className={`${styles.content} ${extraClass}`}>
      ...
      <div className={styles.cards_box}>
        ...
        <Link
          data-test-id={"link-sorting"}
          className={styles.link}
          to="/sorting"
        >
          <div className={`${styles.card} ${styles.arr}`} />
        </Link>
        <Link data-test-id={"link-stack"} className={styles.link} to="/stack">
          <div className={`${styles.card} ${styles.stack}`} />
        </Link>
        <Link data-test-id={"link-queue"} className={styles.link} to="/queue">
          <div className={`${styles.card} ${styles.queue}`} />
        </Link>
        <Link data-test-id={"link-list"} className={styles.link} to="/list">
